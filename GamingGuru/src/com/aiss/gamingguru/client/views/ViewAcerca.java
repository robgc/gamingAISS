...
public class ViewAcerca extends Composite {
	...
	public ViewAcerca() {
		...
		descripcionPanel.setWidget(4, 0,
				new Label("\nPresentamos GamingGuru. Una aplicaci�n capaz de analizar tu "
						+ "\nbiblioteca de Steam y ofrecerte recomendaciones personalizadas"
						+ "\nsobre los juegos de tu g�nero favorito en funci�n de los valores "
						+ "\nanal�ticos de los juegos de dicha biblioteca. Tambi�n te ofreceremos "
						+ "\nenlaces directos a la compra de tus recomendaciones en "
						+ "\nplataformas como Amazon o la propia tienda de Steam dejando a "
						+ "\ntu elecci�n para qu� plataforma deseas hacer la compra."));
