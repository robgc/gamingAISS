...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gamingguru" because\n';
  ...
  $wnd.__gwt_activeModules['gamingguru'] = {
    'moduleName' : 'gamingguru',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/gamingguru.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gamingguru'].superdevmode = true;

  var expectedSuffix = '/gamingguru.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gamingguru + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gamingguru';
  var devModeSessionKey = '__gwtDevModeSession:gamingguru';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gamingguru/gamingguru.nocache.js';
  ...
  $wnd.__gwt_activeModules['gamingguru'].canRedirect = true;
  $wnd.__gwt_activeModules['gamingguru'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gamingguru?user.agent=' + ua + '&_callback=' + callback;
